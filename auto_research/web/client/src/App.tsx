...
const TEXT = {
  zh: {
    ...
    provider: "Provider",
    providerHelp: "OpenAI-compatible 服务类型，例如 openai、siliconflow；claude-code 使用本机 Claude Code CLI，不需要 API key；mock 表示不调用远程 LLM。",
    baseUrl: "Base URL",
  ...
  en: {
    ...
    provider: "Provider",
    providerHelp: "OpenAI-compatible service type, such as openai or siliconflow; claude-code uses the local Claude Code CLI without an API key; mock disables remote LLM calls.",
    baseUrl: "Base URL",
