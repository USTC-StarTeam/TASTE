...
## Source Files
- `third_party/ARIS/skills/experiment-audit/SKILL.md`
...
- Absorb the source `experiment-audit` protocol into the matching native phase.
