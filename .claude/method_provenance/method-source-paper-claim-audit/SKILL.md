...
## Source Files
- `third_party/ARIS/skills/paper-claim-audit/SKILL.md`
...
- Absorb the source `paper-claim-audit` protocol into the matching native phase.
