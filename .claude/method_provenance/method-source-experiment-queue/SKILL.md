...
## Source Files
- `third_party/ARIS/skills/experiment-queue/SKILL.md`
...
- Absorb the source `experiment-queue` protocol into the matching native phase.
...
4. Idempotent: safe to restart scheduler without losing st
```
