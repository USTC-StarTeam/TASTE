...
| 路径 | 作用 |
| --- | --- |
| `framework/scripts/project/create_project.py` | 根据 `framework/resources/templates/project.json` 创建项目（Framework 内部项目工具）。 |
