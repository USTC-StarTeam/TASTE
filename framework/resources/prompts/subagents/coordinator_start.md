...
6. If subagents are available in the current backend or orchestrator, instantiate the three research roles under `framework/resources/prompts/subagents/`; otherwise emulate the same roles sequentially in one runner.
