...
- Training scripts run only through `python framework/scripts/main.py module experimenting --action launch`, and the command after `--` must start with the project experiment Python resolved from project config or runtime environment.
