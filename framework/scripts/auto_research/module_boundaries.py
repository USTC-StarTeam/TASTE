...
STAGE_MODULES: tuple[ModuleBoundary, ...] = (
    ...
    ModuleBoundary(
        ...
        private_backend_roots=("modules/planning/scripts/plan_pipeline.py", "modules/planning/scripts/planning_tools.py", "modules/planning/scripts/build_blocker_action_plan.py", "modules/planning/scripts/propose_next_actions.py"),
    ),
    ModuleBoundary(
        key="environment",
...
SCRIPT_OWNER_OVERRIDES: dict[str, str] = {
    ...
    "environment_data_tools.py": "environment",
    ...
    "repo_data_tools.py": "environment",
    ...
    "experiment_record_tools.py": "experimenting",
