...
from runtime.framework_io import compact_line as compact
...
def build(project: str) -> dict[str, Any]:
    ...
    payload = {
        ...
        "next_action": "Keep framework code content-agnostic. Remaining warnings are runtime/cache directories under the framework root; keep those runtime stores out of framework/scripts when doing the next state-boundary cleanup.",
    }
