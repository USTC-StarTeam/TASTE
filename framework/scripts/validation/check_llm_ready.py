...
from integrations.llm_client import call_llm, get_llm_config, llm_available, llm_disabled_reason
...
def main() -> None:
    ...
    lines.append(f"- Then run `{management_python()} framework/scripts/validation/check_llm_ready.py --project {args.project} --live`.\n")
