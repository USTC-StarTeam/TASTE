...
- Do not call framework/scripts/automation/run_research_trajectory_supervisor.py from this Claude worker. You are already inside a wrapper-owned trajectory item; finish the item, update state, or return a blocked/remaining-queue report.
