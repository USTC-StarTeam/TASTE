...
def main() -> None:
    ...
    for _ in range(max(1, args.max_cycles)):
        ...
        if args.use_llm:
            llm_cmd = [sys.executable, str(SCRIPTS / 'check_llm_ready.py'), '--project', args.project]
        ...
        supervisor_cmd = [
            sys.executable, str(SCRIPTS / 'run_autoscientist_supervisor.py'),
        ...
        stagnation_cmd = [sys.executable, str(SCRIPTS / 'build_stagnation_report.py'), '--project', args.project, '--venue', args.venue]
