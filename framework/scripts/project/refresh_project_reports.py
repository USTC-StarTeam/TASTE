...
from runtime.taste_pythonpath import resolve_script_path, taste_pythonpath_string
...
def _module_cmd(stage: str, action: str, *args: str) -> list[str]:
    return [sys.executable, str(ROOT / "framework/scripts/main.py"), "module", stage, "--action", action, *args]
