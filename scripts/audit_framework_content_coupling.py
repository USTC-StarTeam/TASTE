...
FRAMEWORK_ROOTS = [ROOT / "scripts", ROOT / "modules" / "taste" / "auto_research"]
...
def build(project: str) -> dict[str, Any]:
    ...
    payload = {
        ...
        "next_action": "Keep framework code content-agnostic. Remaining warnings are runtime/cache directories under the framework root; move those runtime stores out of modules/taste/auto_research when doing the next state-boundary cleanup.",
    }
