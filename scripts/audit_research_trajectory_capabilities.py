...
def audit_end_to_end_verification(paths) -> dict[str, Any]:
    ...
    checks = [
        ...
        check("web_exposes_end_to_end_verification", source_contains("../modules/taste/auto_research/web/project_bridge.py", ["research_trajectory_end_to_end_verification", "end_to_end_verification_status"]), evidence=[str(ROOT / "modules" / "taste" / "auto_research" / "web" / "project_bridge.py")]),
    ]
    return {
