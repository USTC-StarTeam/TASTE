...
def main() -> None:
    ...
    lines.append('- After data is placed, run `python3 scripts/build_repo_data_requirements.py --project <project>` and `python3 scripts/probe_repo_dataset.py --project <project> --repo-path <active_repo>` again.\n')
