...
PROVENANCE_ROOT = ROOT / ".claude" / "method_provenance"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Synchronize source-method provenance into native trajectory state.")
