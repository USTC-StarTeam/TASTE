...
def command(project: str, venue: str, script: str, *extra: str) -> str:
    return command(project, script, *((["--venue", venue] if venue else []) + list(extra)))


def command(project: str, script: str, *extra: str) -> str:
    parts = [management_python(), f"scripts/{script}", "--project", project]
        ...
        if route in {"literature_llm_quota_exhausted", "literature_recommendation_gate"}:
            ...
            if gate.get("llm_blocked"):
                ...
                row["success_checks"] = [
                    ...
                    "scripts/check_llm_ready.py --project " + project + " --live exits 0.",
        ...
        "wrapper_managed_actions": [
            {
                ...
                "script": "scripts/run_research_trajectory_supervisor.py",
