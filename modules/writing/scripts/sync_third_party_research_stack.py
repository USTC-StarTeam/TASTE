...
def write_skill_adapter(
    *,
    ...
    body = [
        ...
        "---\n\n",
        f"# {title}\n\n",
        "This audit adapter is generated by the writing module sync_stack action under ignored runtime storage so TASTE can summarize optional method references while operational prompts use native capability names.\n\n",
