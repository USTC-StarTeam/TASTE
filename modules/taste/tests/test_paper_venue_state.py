...
def _load_project_bridge():
    ...
    taste_dir = repo_root / "modules" / "taste"
    for path in [scripts_dir, taste_dir]:
    ...
    _write_json(
        root / "state" / "full_research_cycle.json",
        {
            ...
            "latest_gate": {
                ...
                "blocker_action_plan": {
                    "top_actions": [
                        {"recommended_commands": ["scripts/run_supervision_tick.py --project demo_project --venue nature --supervise"]}
                    ]
                },
            },
        },
