...
spec = importlib.util.spec_from_file_location("build_experiment_record_table", SCRIPTS / "build_experiment_record_table.py")
build_experiment_record_table = importlib.util.module_from_spec(spec)
assert spec and spec.loader
spec.loader.exec_module(build_experiment_record_table)
