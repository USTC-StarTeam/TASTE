...
| Field | Purpose |
| --- | --- |
| `provider` | Display label, for example `openai`, `openai-compatible`, or `local`. |
...
The workflow is licensed under the GNU Affero General Public License v3.0. See [LICENSE](LICENSE).
